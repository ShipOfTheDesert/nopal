...
build-native:
    opam exec -- dune build lib/nopal_style lib/nopal_scene lib/nopal_draw lib/nopal_element lib/nopal_mvu lib/nopal_test lib/nopal_runtime lib/nopal_router lib/nopal_charts examples/todomvc/todomvc.cma
