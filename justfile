...
build-native:
    opam exec -- dune build lib/nopal_style lib/nopal_scene lib/nopal_draw lib/nopal_element lib/nopal_mvu lib/nopal_http lib/nopal_ui lib/nopal_test lib/nopal_runtime lib/nopal_platform lib/nopal_storage lib/nopal_fs_key lib/nopal_navigation lib/nopal_charts lib/nopal_svg lib/nopal_image examples/todomvc/todomvc.cma
