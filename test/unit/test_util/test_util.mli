...
val node_equal : Nopal_test.Test_renderer.node -> Nopal_test.Test_renderer.node -> bool
val node_testable : Nopal_test.Test_renderer.node Alcotest.testable
val check_node : string -> Nopal_test.Test_renderer.node -> Nopal_test.Test_renderer.node -> unit
